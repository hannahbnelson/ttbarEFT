...
class AnalysisProcessor(processor.ProcessorABC):
    def __init__(self, samples, wc_names_lst=[], hist_lst = None, dtype=np.float32, do_errors=False):
        ...
        self._histo_dict = {
            ...
            "top_pt"   :HistEFT(
                            proc_axis,
                            syst_axis,
                            hist.axis.Regular(bins=35, start=0, stop=700, name="top_pt", label="top $p_T$ [GeV]"),
                            wc_names=wc_names_lst,
                            label="Events"),
            "sow"       :HistEFT(
                            proc_axis,
            ...
            "nevents"       :HistEFT(
                            proc_axis,
                            syst_axis,
                            hist.axis.Regular(bins=1, start=0, stop=2, name="nevents", label="nevents"), 
                            wc_names=wc_names_lst, 
                            label="Events"),
        }
    ...
    def process(self, events):
        ...
        # see https://github.com/TopEFT/topeft/blob/3471b740a36b0b781439450b9858db2cd8fcd939/analysis/topeft_run2/analysis_processor.py#L164
        ...
        if eft_coeffs is None:  #alternatively `if not isData:`
        ...
        top_pt_cut = gen_top.pt[event_selection_mask]
        ...
        nevents_fill_info={
            'nevents': counts, 
            "process": hist_axis_name,
            "weight" : genw[event_selection_mask],
            "eft_coeff" : None,
        }
