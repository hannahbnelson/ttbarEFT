...
def make_samples_dict(files, wc_name, sample_names=None, hist_name='sow_norm', wc_max=6.0, norm=1.0):
...
if __name__ == '__main__':
    ...
    for wc in wc_list:   
        ...
        samples = make_samples_dict(files, wc_name=wc, hist_name=hist_name, wc_max=wc_lim, norm=5.63)
        make_scatter_plot(samples, scatter_lst, wc_lim, wc, proc_text=tW_proc_text, scan_type=scan_type)
